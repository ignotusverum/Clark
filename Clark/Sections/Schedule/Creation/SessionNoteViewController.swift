//
//  SessionNoteViewController.swift
//  Clark
//
...
enum SessionNoteCells {
    case note
}

class SessionNoteViewController: UIViewController, HelpNavigationProtocol, CreationViewControllerProtocol {
    ...
    /// Datasource
    var datasource: [SessionNoteCells] = [.note]
...
extension SessionNoteViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionElementKindSectionHeader:
            ...
            headerView.titleLabel.attributedText = NSAttributedString(string: "Add notes to the\nsession", attributes: [NSParagraphStyleAttributeName: paragraph])
...
// MARK: - CollectionView Datasource
extension SessionNoteViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath)-> UICollectionViewCell {
        ...
        inputCell.placeholder = "e.g. remember to bring the textbook\nto the session!"
...
extension SessionNoteViewController: FormInputCellDelegate {
