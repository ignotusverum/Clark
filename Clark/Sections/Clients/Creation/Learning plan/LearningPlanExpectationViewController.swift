//
//  LearningPlanExpectationViewController.swift
//  Clark
//
...
enum LearningPlanExpectationCells {
    case workTime
    case expectationsNote
}

class LearningPlanExpectationViewController: UIViewController, HelpNavigationProtocol, CreationViewControllerProtocol {
    
    /// Title
    var navigationTitle: String
    
    /// On next
    var nextButtonSuccess: ((String, String)->())?
    ...
    /// Datasource
    var datasource: [LearningPlanExpectationCells] = [.workTime, .expectationsNote]
    ...
    var firstInputCell: SuffixInputCell? = nil
    ...
    func onNextButton(_ sender: UIButton) {
        ...
        guard workTime.length >= 1 else {
            
            /// Show error
            BannerManager.manager.showBannerForErrorText("Please enter outside work time", category: .all)
            
            return
        }
        
        nextButtonSuccess?(progress, workTime)
    }
    ...
    func onNextButtonCallback(_ completion: @escaping ((String, String)->())) {
...
extension LearningPlanExpectationViewController: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath)-> CGSize {
        let type = datasource[indexPath.row]
        let height: CGFloat = type == .workTime ? 100 : 250
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionElementKindSectionHeader:
            ...
            headerView.titleLabel.attributedText = NSAttributedString(string: "What else is expected?", attributes: [NSParagraphStyleAttributeName: paragraph])
...
// MARK: - CollectionView Datasource
extension LearningPlanExpectationViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath)-> UICollectionViewCell {
        ...
        case .expectationsNote:
            ...
            inputCell.placeholder = "Describe any other expectations. Be specific as possible."
        ...
        case .workTime:
            ...
            firstInputCell = durationCell
            
            durationCell.delegate = self
            durationCell.indexPath = indexPath
            durationCell.suffixText = "Hour"
            
            durationCell.titleText = "How much outside work required?"
            durationCell.formInput.text = workTime
            durationCell.placeholder = "1"
...
extension LearningPlanExpectationViewController: FormInputCellDelegate {
    
    /// Return button pressed
    func textFieldHitReturn(_ textVies: UITextView, indexPath: IndexPath){
        if datasource[indexPath.row] == .expectationsNote {
