 ...
 */
open class ClarkMessageNode: GeneralMessengerCell {
    ...
    {
        self.avatarButtonNode.addTarget(self, action:  #selector(ClarkMessageNode.avatarClicked), forControlEvents: .touchUpInside)
