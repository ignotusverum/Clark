...
class SessionCalendarCell: UICollectionViewCell, DividerCellProtocol, ExpandableCellProtocol, TitleCellProtocol, FormInputCellProtocol, AccessoryCellProtocol {
...
extension SessionCalendarCell: UITextViewDelegate {
