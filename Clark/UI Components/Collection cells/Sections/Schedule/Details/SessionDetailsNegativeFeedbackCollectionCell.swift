//
//  NegativeFeedbackCollectionViewCell.swift
//  Clark
//
...
class SessionDetailsNegativeFeedbackCell: UICollectionViewCell, TitleCellProtocol, DividerCellProtocol, SessionFeedbackCellProtocol, SessionDetailsCellProtocol {
    ...
    var session: Session! {
        didSet {
            ...
            /// Title setup
            titleText = "What needs improvement"
    ...
    class func calculatedHeight(session: Session)-> CGFloat {
        let number = session.sessionReport?.nagativeDimention.count ?? 0
...
extension SessionDetailsNegativeFeedbackCell: UICollectionViewDelegateFlowLayout {
...
// MARK: - CollectionView Datasource
extension SessionDetailsNegativeFeedbackCell: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int)-> Int {
        return session.sessionReport?.nagativeDimention.count ?? 0
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath)-> UICollectionViewCell {
        ...
        let dimention = session.sessionReport!.nagativeDimention[indexPath.row]
