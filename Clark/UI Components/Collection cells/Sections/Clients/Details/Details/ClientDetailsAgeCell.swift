...
class ClientDetailsAgeCell: UICollectionViewCell, DividerCellProtocol, DectiptionColorCollectionCellprotocol, SimpleTitleCellProtocol {
    ...
    var student: Student! {
        didSet {
            ...
            /// Description text
            descriptionText = student.age?.stringValue
    ...
    class func calculatedHeight(student: Student)-> CGFloat {
        return (student.age?.intValue ?? 0) > 0 ? 66 : 0
    }
}
