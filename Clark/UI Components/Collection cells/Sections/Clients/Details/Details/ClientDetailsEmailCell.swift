...
class ClientDetailsEmailCell: UICollectionViewCell, DividerCellProtocol, DectiptionColorCollectionCellprotocol, SimpleTitleCellProtocol {
    ...
    class func calculatedHeight(student: Student)-> CGFloat {
        return student.email != nil && (student.email?.length ?? 0 > 0) ? 66 : 0
    }
}
