...
class ClientDetailsSubjectsCell: UICollectionViewCell, DividerCellProtocol, DectiptionColorCollectionCellprotocol, SimpleTitleCellProtocol {
    ...
    var student: Student! {
        didSet {
            ...
            /// Description text
            descriptionText = student.subjectsArray.first?.name
    ...
    class func calculatedHeight(student: Student)-> CGFloat {
        return student.subjectsArray.first != nil ? 66 : 0
    }
}
