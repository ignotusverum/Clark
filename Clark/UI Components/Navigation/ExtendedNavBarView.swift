...
class ExtendedNavBarView: UIView, ExtendedNavBarProtocol {
    ...
    lazy var rightButton: UIButton = {
        ...
        button.imageEdgeInsets = UIEdgeInsets(top: 35, left: 35, bottom: 15, right: 15)
    ...
    init(title: String, style: ExtendedNavigationStyle, presentation: ExtendedNavigationPresentation = .none, type: ExtendedNavigationType = .clean, isRightButtonEnabled: Bool = false, image: UIImage = #imageLiteral(resourceName: "plus_icon")) {
    ...
    func customInit() {
        ...
        self.rightButton.setImage(rightImage, for: .normal)
